...
-- Тестовые данные
INSERT INTO games (title, start_scene_id) VALUES
                                              ('Тестовая новелла', 'scene_1'),
                                              ('Демо игра', 'demo_start');

-- Тестовая сцена 1
INSERT INTO scenes (game_id, scene_external_id, background, music, initial_characters) VALUES
    (
        1,
        'scene_1',
        'forest.jpg',
...
INSERT INTO dialogues (scene_id, dialogue_order, character_id, text, character_changes, next_dialogue_id) VALUES
                                                                                                              (1, 1, 'narrator', 'Вы оказываетесь в таинственном лесу...', NULL, 2),
                                                                                                              (1, 2, 'hero', 'Интересно, что здесь происходит? Куда я попал?', NULL, 3),
                                                                                                              (1, 3, NULL, 'Из-за деревьев появляется незнакомец...', '[{"character_id": "npc", "visible": true}]', 4),
                                                                                                              (1, 4, 'npc', 'Приветствую, путник! Давно я не видел здесь новых лиц.', '[{"character_id": "hero", "sprite": "hero_surprised.png"}]', 5);

-- Диалог с выбором
INSERT INTO dialogues (scene_id, dialogue_order, character_id, text, character_changes, is_choice) VALUES
    (1, 5, NULL, 'Что вы ответите незнакомцу?', NULL, TRUE);

-- Варианты выбора
INSERT INTO choices (dialogue_id, choice_text, next_scene_id) VALUES
                                                                  (5, 'Поздороваться вежливо', 'scene_2'),
                                                                  (5, 'Спросить "Кто ты?"', 'scene_3'),
                                                                  (5, 'Промолчать и уйти', 'scene_4');

-- Демо диалоги
INSERT INTO dialogues (scene_id, dialogue_order, character_id, text, character_changes, next_scene_id) VALUES
                                                                                                           (2, 1, 'narrator', 'Вы просыпаетесь в незнакомом городе...', NULL, 'demo_scene_2'),
